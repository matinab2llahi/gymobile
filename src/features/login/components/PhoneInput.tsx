        ...
        <>
            <div className="flex flex-col gap-2">
                ...
                <div className="flex items-stretch gap-2" dir="ltr">
                    <div
                        className="flex items-center gap-1 rounded-xl border border-border bg-surface px-3 text-sm text-text-secondary">
                        <span>IR</span>
                    ...
                    <input
                        ...
                        className=" w-full rounded-xl border border-border bg-background px-4 py-3 text-text-primary
